...
function captureScreen(captureScreenInfo, appRoot) {
    logger.info('Start to capture screenshot for websiteUrl: ' + captureScreenInfo.websiteUrl);
    ...
    return screenshotModels.Screenshot.promisifiedFind({
        ...
        .then(function(instance) {
            // phantom instance created, increase phantom instance counter
            dataStore.numberOfCurrentRunningPhantomInstances += 1;
            ...
            return page.property('onConsoleMessage', function(msg) {
                ...
                .then(function(status) {
                    if (status != 'success') {
                        ...
                        // phantom instance destroyed, decrease phantom instance counter
                        dataStore.numberOfCurrentRunningPhantomInstances -= 1;
                        var err = {
                            logLevel: 'error',
