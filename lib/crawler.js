 ...
 * otherwise retry after 100ms until reached max retries.
            ...
            return page.property('onConsoleMessage', function(msg) {
                ...
                .then(function(status) {
                    ...
                    if (placementType === 'native') {
                        ...
                        // The multi pane native ad wrapper loads asynchronously, so need to wailt until it APPEARS in DOM when evaluating page
