    ...
    return screenshotModels.Screenshot.promisifiedFind({
        ...
        .then(function(page) {
            ...
            return page.property('onConsoleMessage', function(msg) {
                ...
                .then(function(imageURL) {
                    ...
                    logger.info(`SUCCESS. Now saving screenshot metadata to MongoDB for this request: ------ websiteUrl: ${captureScreenInfo.websiteUrl}, pid: ${captureScreenInfo.pid}, crgId: ${captureScreenInfo.crgId}`);
        ...
        .catch(function(err) {
            ...
            if (err.logLevel && err.logLevel === 'warn') {
                ...
                logger.error(`Error scraping the following screenshot: ------ websiteUrl: ${captureScreenInfo.websiteUrl}, pid: ${captureScreenInfo.pid}, crgId: ${captureScreenInfo.crgId}. Error message: ${errorString}`);
            }
            if (phantomInstance) {
                phantomInstance.exit();
            }
