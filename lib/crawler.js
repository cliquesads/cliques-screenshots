...
function waitUntil(asyncTest, maxRetries, errObj) {
    ...
    return new Promise(function(resolve, reject) {
        function wait() {
            numOfTries ++;
            return asyncTest().then(function(value) {
                if (value === true) {
                    resolve();
        ...
        .then(function(status) {
            ...
            if (placementType === 'native') {
                ...
                .then(function() {
                    ...
                    var nativePaneSelector = 'a[href*="pid=' + captureScreenInfo.pid + '"]';
                    return waitUntil(function() {
                ...
                .then(function() {
                    ...
                    return waitUntil(function() {
                        return page.evaluate(function(multiPaneNativeCount) {
                            ...
                            if (!nativeImages) {
                                return false;
                            } else if (nativeImages.length < multiPaneNativeCount) {
                                return false;
                            } else {
